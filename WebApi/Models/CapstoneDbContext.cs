...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=tcp:kalpana123.database.windows.net,1433;Initial Catalog=CapstoneDB;User Id=kalpana123;Password=18G21A0518@;Encrypt=True;TrustServerCertificate=true;Connection Timeout=30;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminInfo>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__AdminInf__3214EC077483EAF3");
        ...
        {
            entity.HasKey(e => e.BlogId).HasName("PK__BlogInfo__54379E30C514C41C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__EmpInfo__3214EC07603C3A8C");

            entity.ToTable("EmpInfo");

            entity.HasIndex(e => e.EmailId, "UQ__EmpInfo__7ED91ACE2AAABB63").IsUnique();
